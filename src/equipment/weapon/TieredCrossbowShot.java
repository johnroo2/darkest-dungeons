...
public class TieredCrossbowShot extends Projectile{
	final int SIZE = 40;
	
	int type, size, minDmg, maxDmg;
	BufferedImage img;
	
	public TieredCrossbowShot(int x, int y, int targetX, int targetY, double speed, int range, int type, int minDmg, int maxDmg) {
		...
		this.img = Rotate.rotateImage(Projectile.BULLETS_BOW.get(type), rotation);
