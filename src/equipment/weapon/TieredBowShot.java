...
public class TieredBowShot extends Projectile{
	final int SIZE = 36;
	
	int type, size, minDmg, maxDmg;
	BufferedImage img;
	
	public TieredBowShot(int x, int y, int targetX, int targetY, double speed, int range, int type, int minDmg, int maxDmg, int alt) {
